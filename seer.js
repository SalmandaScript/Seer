...
/*function to change button behavior*/
function salmanda1(){
...
/*function to change button behavior horoscope signs*/
...
function salmanda16(){
document.getElementById ("demo16"). style. color ="white";

document.getElementById ("demo16"). style. fontweight ="bold";

document.getElementById
 ("demo16"). style. fontsize ="30%";

document.getElementById
 ("demo16"). style. background ="maroon";
}
...
//function to open Sm Technology
function SmTech(){
open("https://salmandascript.github.io/SM Technology/smtech.html");
}
